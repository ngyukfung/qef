    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-white dark:from-gray-900 dark:to-indigo-950 text-gray-900 dark:text-gray-100 ">
      ...
      <main className="md:w-[48rem] lg:w-[64rem] w-full mx-auto px-4 py-12 space-y-6">
        <section className="bg-white p-8 rounded-xl shadow-md">
          <h2 className="text-2xl/8 md:text-3xl/8 font-semibold mb-4 text-indigo-700">About the Quality Education Fund (QEF)</h2>
          <p>
        ...
        <section className="bg-white p-8 rounded-xl shadow-md">
          <h2 className="text-2xl/8 md:text-3xl/8 font-semibold mb-4 text-indigo-700">Funded Project</h2>
          <p>
        ...
        <section className="bg-white p-8 rounded-xl shadow-md">
          <h2 className="text-2xl/8 md:text-3xl/8 font-semibold mb-4 text-indigo-700">Lambda Math Platform</h2>
          <p>
